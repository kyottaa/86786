...
function loadMusic(song) {
    ...
    volumeRange.value = isMuted ? 0 : music.volume * 100; // Установите ползунок на текущее значение громкости или 0, если отключен звук
}
...
volumeBtn.addEventListener('click', (e) => {
    e.stopPropagation(); // Остановить всплытие события, чтобы не закрылся ползунок сразу
